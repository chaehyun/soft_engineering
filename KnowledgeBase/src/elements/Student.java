...
public class Student extends User implements Comparable<Student> {
    ...
    public Student(String Name, String ContactNumber, String Id, String Password,
            float Gpa, String Sex, int Grade, int Age, ArrayList<TechSkills> TechSkills, ArrayList<NonTechSkills> NonTechSkills) {
    ...
    /**
     * @param nonTechSkills the nonTechSkills to set
     */
