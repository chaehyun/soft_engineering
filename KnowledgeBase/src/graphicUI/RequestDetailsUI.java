...
public class RequestDetailsUI extends javax.swing.JFrame
{
	...
	private void initComponents()
	{
		...
		jTextField3.setText(Integer.toString(selectedRequest
				.getNumberOfStudents()));
		...
		jTextField5
				.setText(Integer.toString(selectedRequest.getMinimumGrade()));
		...
		jButton1.addMouseListener(new MouseAdapter()
		{
			...
			{
				new SearchStudentsUI(selectedRequest).setVisible(true);
				RequestDetailsUI.this.setVisible(false);
			}
		});
		...
		jTable1.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] {}, new String[] { "Name", "GPA", "Answer",
						"Pick" })
		{
