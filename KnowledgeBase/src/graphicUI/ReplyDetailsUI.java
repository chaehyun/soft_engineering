...
public class ReplyDetailsUI extends javax.swing.JFrame {
	...
	jTextArea4
		.setText("My answer is Yes, but I only know Oracle SQL, not MySQL.");
	...
	try {
	    ...
	    java.util.logging.Logger.getLogger(ReplyDetailsUI.class.getName())
	...
	java.awt.EventQueue.invokeLater(new Runnable() {
	    public void run() {
		new ReplyDetailsUI().setVisible(true);
	    }
	});
    }
